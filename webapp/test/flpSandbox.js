		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "This is a test project for testing",
									"targetURL": "#testingproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testingproject-display": {
								"semanticObject": "testingproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testingproject",
									"url": sap.ui.require.toUrl("testingproject")
								}
							}
						}
					}
